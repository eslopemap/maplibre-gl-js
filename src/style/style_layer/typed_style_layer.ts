...
import type {TerrainAnalysisStyleLayer} from './terrain_analysis_style_layer';
import type {LineStyleLayer} from './line_style_layer';
import type {SymbolStyleLayer} from './symbol_style_layer';

export type TypedStyleLayer = CircleStyleLayer | FillStyleLayer | FillExtrusionStyleLayer | HeatmapStyleLayer | HillshadeStyleLayer | TerrainAnalysisStyleLayer | LineStyleLayer | SymbolStyleLayer;
